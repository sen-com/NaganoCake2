...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { item_id: @order_detail.item_id, order_id: @order_detail.order_id, production_status: @order_detail.production_status, quantitty: @order_detail.quantitty, tax_included_price: @order_detail.tax_included_price } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { item_id: @order_detail.item_id, order_id: @order_detail.order_id, production_status: @order_detail.production_status, quantitty: @order_detail.quantitty, tax_included_price: @order_detail.tax_included_price } }
